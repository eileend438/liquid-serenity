      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 text-center lg:text-left max-w-2xl">
            ...
            >
              Увеличиваю прибыль собственнику бизнеса, делая его компанию
              ВНЕКОНКУРЕНТНОЙ надолго или навсегда — через СОЗДАНИЕ УНИКАЛЬНОГО ПРОДУКТА и
              формирование НОВОЙ КАТЕГОРИИ РЫНКА С ВЫСОКОУСТОЙЧИВОЙ БИЗНЕС-МОДЕЛЬЮ.
